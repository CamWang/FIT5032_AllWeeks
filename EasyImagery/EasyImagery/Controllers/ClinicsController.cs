...
namespace EasyImagery.Controllers
{
    public class ClinicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,ManagerId,Address")] Clinic clinic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,ManagerId,Address")] Clinic clinic)
        {
            if (id != clinic.Id)
            {
                return NotFound();
